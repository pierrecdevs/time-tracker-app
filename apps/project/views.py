...
def projects(request):
    ...
    if request.method == 'POST':
        ...
        if title:
            ...
            messages.info(request, f'Project "{title}" has been added.')
...
def edit_project(request, project_id):
    ...
    if request.method == 'POST':
        ...
        if title:
            ...
            messages.info(request, 'Project has been updated.')
...
def edit_entry(request, project_id, task_id, entry_id):
    ...
    if request.method == 'POST':
        ...
        messages.info(request, 'Entry has been updated.')
...
def track_entry(request, entry_id):
    ...
    if request.method == 'POST':
        ...
        if project and task:
            ...
            messages.info(request, 'Time as been tracked')
            return redirect('dashboard')
