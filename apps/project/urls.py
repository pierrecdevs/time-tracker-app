...
from .views import delete_entry, delete_untracked_entry, edit_entry, edit_task, project, projects, edit_project, task, track_entry
from .api import api_get_tasks, api_start_timer, api_stop_timer, api_discard_timer
app_name='project'
